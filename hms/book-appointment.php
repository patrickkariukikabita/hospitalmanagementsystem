...
function book_appointment($con, $specialization, $doctorid, $fees, $appdate, $apptime, $session_id)
{
	$userstatus = 1;
	$docstatus = 1;
	...
	VALUES('$specialization', '$doctorid', '$session_id', '$fees', '$appdate', '$apptime', '$userstatus', '$docstatus')");
	if ($query) {
		return [
...
if (isset($_POST['submit'])) {
	$response = book_appointment($con, $_POST['Doctorspecialization'], $_POST['doctor'], $_POST['fees'], $_POST['appdate'], $_POST['apptime'], $_SESSION['id']);
