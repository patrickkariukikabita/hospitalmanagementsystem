...
if (isset($_POST['submit'])) {
    ...
    // testcase 1
    function submit_contact_info($name, $email, $mobileno, $dscrption, $con)
    {
        ...
        if ($stmt->execute()) {
            ...
            // If there was an error in insertion
            return [
                "message" => "There was an error in submitting your information.",
                "redirect_url" => null
            ];
        }
    }
    ...
    if (isset($_POST['submit'])) {
        $response = submit_contact_info($_POST['fullname'], $_POST['emailid'], $_POST['mobileno'], $_POST['description'], $con);
